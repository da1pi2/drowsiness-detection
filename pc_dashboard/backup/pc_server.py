...
class DrowsinessAnalyzer:
    ...
    def __init__(self):
        ...
        self.LEFT_EYE = list(range(42, 48)) #6 punti
        self.RIGHT_EYE = list(range(36, 42)) #6 punti
        self.MOUTH = list(range(60, 68)) #8 punti
        #? i restanti punti rappresentano altre parti del viso(naso, sopracciglia, contorno viso)
    ...
    def mouth_aspect_ratio(self, mouth):
        ...
        A = distance.euclidean(mouth[1], mouth[7]) # vertical 1
        B = distance.euclidean(mouth[3], mouth[5]) # vertical 2
